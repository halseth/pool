...
type Match struct {
	// The nonce of the local order that got matched.
	OrderNonce []byte `protobuf:"bytes,1,opt,name=order_nonce,json=orderNonce,proto3" json:"order_nonce,omitempty"`
	// Type is the type of the local order involved in this match.
	OrderType string `protobuf:"bytes,2,opt,name=order_type,json=orderType,proto3" json:"order_type,omitempty"`
	// Duration is the agreed duration in blocks of the match. This will be
	// equal to the minimum duration of the bid part of this match.
	Duration uint32 `protobuf:"varint,3,opt,name=duration,proto3" json:"duration,omitempty"`
	// The units matched.
	UnitsFilled uint64 `protobuf:"varint,4,opt,name=units_filled,json=unitsFilled,proto3" json:"units_filled,omitempty"`
	// Premium is the lump sum premium paid to the maker.
	PremiumSat uint64 `protobuf:"varint,5,opt,name=premium_sat,json=premiumSat,proto3" json:"premium_sat,omitempty"`
	// The fee paid to the auctioneer for this match.
	...
	// The key of the other node that will use to craft the channel funding
	// TX's 2-of-2 multi signature output.
	MultiSigKey          []byte   `protobuf:"bytes,7,opt,name=multi_sig_key,json=multiSigKey,proto3" json:"multi_sig_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Match) GetOrderNonce() []byte {
	if m != nil {
		return m.OrderNonce
	}
	return nil
...
func (m *Match) GetOrderType() string {
	if m != nil {
		return m.OrderType
	}
	return ""
...
func (m *Match) GetUnitsFilled() uint64 {
	if m != nil {
...
func (m *Match) GetPremiumSat() uint64 {
	if m != nil {
		return m.PremiumSat
	}
	return 0
...
func (m *Match) GetExecutionFeeSat() uint64 {
	if m != nil {
...
func (m *Match) GetMultiSigKey() []byte {
	if m != nil {
...
type LocalBatchSnapshot struct {
	...
	BatchVersion uint32 `protobuf:"varint,1,opt,name=batch_version,json=batchVersion,proto3" json:"batch_version,omitempty"`
	// The ID of the batch.
	BatchId []byte `protobuf:"bytes,2,opt,name=batch_id,json=batchId,proto3" json:"batch_id,omitempty"`
	// The price orders in this batch were cleared at. This is expressed as
	// parts per billion per block.
	ClearingPrice uint32 `protobuf:"varint,3,opt,name=clearing_price,json=clearingPrice,proto3" json:"clearing_price,omitempty"`
	// The fee rate that was used for the batch transaction.
	BatchTxFeeRateSatPerKw uint64 `protobuf:"varint,4,opt,name=batch_tx_fee_rate_sat_per_kw,json=batchTxFeeRateSatPerKw,proto3" json:"batch_tx_fee_rate_sat_per_kw,omitempty"`
	// The transaction hash of the batch transaction.
	BatchTx []byte `protobuf:"bytes,5,opt,name=batch_tx,json=batchTx,proto3" json:"batch_tx,omitempty"`
	// The total chain fees paid by the trader to participate in this batch.
	ChainFeesSat uint64 `protobuf:"varint,6,opt,name=chain_fees_sat,json=chainFeesSat,proto3" json:"chain_fees_sat,omitempty"`
	// The matches the trader was involved in in this batch.
...
func (m *LocalBatchSnapshot) Reset()         { *m = LocalBatchSnapshot{} }
func (m *LocalBatchSnapshot) String() string { return proto.CompactTextString(m) }
func (*LocalBatchSnapshot) ProtoMessage()    {}
func (*LocalBatchSnapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8f61804588c75fe, []int{24}
}

func (m *LocalBatchSnapshot) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_LocalBatchSnapshot.Unmarshal(m, b)
}
func (m *LocalBatchSnapshot) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_LocalBatchSnapshot.Marshal(b, m, deterministic)
}
func (m *LocalBatchSnapshot) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LocalBatchSnapshot.Merge(m, src)
}
func (m *LocalBatchSnapshot) XXX_Size() int {
	return xxx_messageInfo_LocalBatchSnapshot.Size(m)
}
func (m *LocalBatchSnapshot) XXX_DiscardUnknown() {
	xxx_messageInfo_LocalBatchSnapshot.DiscardUnknown(m)
}

var xxx_messageInfo_LocalBatchSnapshot proto.InternalMessageInfo

func (m *LocalBatchSnapshot) GetBatchVersion() uint32 {
	if m != nil {
...
func (m *LocalBatchSnapshot) GetBatchId() []byte {
	if m != nil {
		return m.BatchId
	}
	return nil
...
func (m *LocalBatchSnapshot) GetClearingPrice() uint32 {
	if m != nil {
...
func (m *LocalBatchSnapshot) GetBatchTxFeeRateSatPerKw() uint64 {
	if m != nil {
...
func (m *LocalBatchSnapshot) GetBatchTx() []byte {
	if m != nil {
		return m.BatchTx
	}
	return nil
...
func (m *LocalBatchSnapshot) GetChainFeesSat() uint64 {
	if m != nil {
		return m.ChainFeesSat
	}
	return 0
}

func (m *LocalBatchSnapshot) GetMatches() []*Match {
	if m != nil {
		return m.Matches
	}
	return nil
...
type ListLocalBatchSnapshotsRequest struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ListLocalBatchSnapshotsRequest) Reset()         { *m = ListLocalBatchSnapshotsRequest{} }
func (m *ListLocalBatchSnapshotsRequest) String() string { return proto.CompactTextString(m) }
func (*ListLocalBatchSnapshotsRequest) ProtoMessage()    {}
func (*ListLocalBatchSnapshotsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8f61804588c75fe, []int{25}
}

func (m *ListLocalBatchSnapshotsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListLocalBatchSnapshotsRequest.Unmarshal(m, b)
}
func (m *ListLocalBatchSnapshotsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListLocalBatchSnapshotsRequest.Marshal(b, m, deterministic)
}
func (m *ListLocalBatchSnapshotsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListLocalBatchSnapshotsRequest.Merge(m, src)
}
func (m *ListLocalBatchSnapshotsRequest) XXX_Size() int {
	return xxx_messageInfo_ListLocalBatchSnapshotsRequest.Size(m)
}
func (m *ListLocalBatchSnapshotsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ListLocalBatchSnapshotsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ListLocalBatchSnapshotsRequest proto.InternalMessageInfo

type ListLocalBatchSnapshotsResponse struct {
	Batches              []*LocalBatchSnapshot `protobuf:"bytes,1,rep,name=batches,proto3" json:"batches,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}

func (m *ListLocalBatchSnapshotsResponse) Reset()         { *m = ListLocalBatchSnapshotsResponse{} }
func (m *ListLocalBatchSnapshotsResponse) String() string { return proto.CompactTextString(m) }
func (*ListLocalBatchSnapshotsResponse) ProtoMessage()    {}
func (*ListLocalBatchSnapshotsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8f61804588c75fe, []int{26}
}

func (m *ListLocalBatchSnapshotsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListLocalBatchSnapshotsResponse.Unmarshal(m, b)
}
func (m *ListLocalBatchSnapshotsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListLocalBatchSnapshotsResponse.Marshal(b, m, deterministic)
}
func (m *ListLocalBatchSnapshotsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListLocalBatchSnapshotsResponse.Merge(m, src)
}
func (m *ListLocalBatchSnapshotsResponse) XXX_Size() int {
	return xxx_messageInfo_ListLocalBatchSnapshotsResponse.Size(m)
}
func (m *ListLocalBatchSnapshotsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ListLocalBatchSnapshotsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ListLocalBatchSnapshotsResponse proto.InternalMessageInfo

func (m *ListLocalBatchSnapshotsResponse) GetBatches() []*LocalBatchSnapshot {
	if m != nil {
		return m.Batches
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Match)(nil), "clmrpc.Match")
	proto.RegisterType((*LocalBatchSnapshot)(nil), "clmrpc.LocalBatchSnapshot")
	proto.RegisterType((*ListLocalBatchSnapshotsRequest)(nil), "clmrpc.ListLocalBatchSnapshotsRequest")
	proto.RegisterType((*ListLocalBatchSnapshotsResponse)(nil), "clmrpc.ListLocalBatchSnapshotsResponse")
...
var fileDescriptor_b8f61804588c75fe = []byte{
	...
	,
}
...
type TraderClient interface {
	...
	// llm: `auction listbatches`
	//ListLocalBatchSnapshots returns a batch snapshot for all batches the trader
	//has participated in.
	ListLocalBatchSnapshots(ctx context.Context, in *ListLocalBatchSnapshotsRequest, opts ...grpc.CallOption) (*ListLocalBatchSnapshotsResponse, error)
	// llm: `auction fee`
...
func (c *traderClient) ListLocalBatchSnapshots(ctx context.Context, in *ListLocalBatchSnapshotsRequest, opts ...grpc.CallOption) (*ListLocalBatchSnapshotsResponse, error) {
	out := new(ListLocalBatchSnapshotsResponse)
	err := c.cc.Invoke(ctx, "/clmrpc.Trader/ListLocalBatchSnapshots", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TraderServer interface {
	...
	//ListLocalBatchSnapshots returns a batch snapshot for all batches the trader
	//has participated in.
	ListLocalBatchSnapshots(context.Context, *ListLocalBatchSnapshotsRequest) (*ListLocalBatchSnapshotsResponse, error)
	// llm: `auction fee`
	//AuctionFee returns the current auction order execution fee specified by the
	//auction server.
...
func (*UnimplementedTraderServer) ListLocalBatchSnapshots(ctx context.Context, req *ListLocalBatchSnapshotsRequest) (*ListLocalBatchSnapshotsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListLocalBatchSnapshots not implemented")
}
...
func _Trader_ListLocalBatchSnapshots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListLocalBatchSnapshotsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TraderServer).ListLocalBatchSnapshots(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clmrpc.Trader/ListLocalBatchSnapshots",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TraderServer).ListLocalBatchSnapshots(ctx, req.(*ListLocalBatchSnapshotsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Trader_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListLocalBatchSnapshots",
			Handler:    _Trader_ListLocalBatchSnapshots_Handler,
		},
		{
